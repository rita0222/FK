...
namespace FK_CLI
{
	...
	public:
		 ...
		 *	本関数では、ファイル名とともにオブジェクト名を指定する必要があります。
		 *
		 *	なお、本関数は ReadMQOData(array<Byte>^, String^, bool, bool, bool) において、
		 ...
		 *	本関数では、ファイル名とともにオブジェクト名を指定する必要があります。
		 *
		 *	なお、本関数は ReadMQOData(array<Byte>^, String^, int, bool, bool, bool) において、
		 *	第6引数に false を入力している場合と同義となります。
		 *
		 *	\param[in]	buffer		データが格納されているバッファ
		 *
		 ...
		 *
		 *	なお、本関数は
		 *	WriteVRMLFile(String^, array<double>^,
		 *	array<fk_Vector^>^, fk_Material^, bool) において、
		 *	第5引数に false を入力している場合と同義となります。
		 *
		 *	\param[in]	fileName		ファイル名
		 *
		 ...
		 *	本関数によって破棄されます。
		 *
		 *	なお、本関数は MoveVPosition(int, array<double>^, int) において、
		 *	第3引数に 0 を入力した場合と同義になります。
		 *
		 *	\param[in]	vertexID		頂点ID
		 *
		 ...
		 *	与えられたインデックスフェースセット情報から、形状を生成します。
		 *
		 *	なお、本関数は MakeIFSet(int, int, array<int>^, int, array<fk_Vector^>^, int) において、
