...
namespace FK_CLI {
	...
	fk_Vector^ fk_Model::getPosition(void)
	{
	...
	fk_Vector^ fk_Model::getVec(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
		*V->pVec = GetP()->getVec();
		return V;
	...
	fk_Vector^ fk_Model::getUpvec(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
	...
	fk_Angle^ fk_Model::getAngle(void)
	{
	...
	fk_Matrix^ fk_Model::getMatrix(void)
	{
	...
	fk_Matrix^ fk_Model::getInvMatrix(void)
	{
		fk_Matrix^ M = gcnew fk_Matrix();
	...
	fk_Matrix^ fk_Model::getBaseMatrix(void)
	{
		fk_Matrix^ M = gcnew fk_Matrix();
	...
	fk_Matrix^ fk_Model::getInvBaseMatrix(void)
	{
		fk_Matrix^ M = gcnew fk_Matrix();
	...
	bool fk_Model::setScale(double argScale)
	{
		return GetP()->setScale(argScale);
	}

	bool fk_Model::setScale(double argScale, fk_Axis argAxis)
	{
		return GetP()->setScale(argScale, GetAxis(argAxis));
	}

	bool fk_Model::setScale(double argX, double argY, double argZ)
	{
		return GetP()->setScale(argX, argY, argZ);
	}
	bool fk_Model::prdScale(double argScale)
	{
		return GetP()->prdScale(argScale);
	}

	bool fk_Model::prdScale(double argScale, fk_Axis argAxis)
	{
		return GetP()->prdScale(argScale, GetAxis(argAxis));
	}

	bool fk_Model::prdScale(double argX, double argY, double argZ)
	{
		return GetP()->prdScale(argX, argY, argZ);
	}

	double fk_Model::getScale(void)
	{
		return GetP()->getScale();
	}

	double fk_Model::getScale(fk_Axis argAxis)
	{
		return GetP()->getScale(GetAxis(argAxis));
	}

	bool fk_Model::getScaleMode(void)
	{
		return GetP()->getScaleMode();
	}

	bool fk_Model::glFocus(fk_Vector^ argV)
	{
		if(!argV) return false;
		return GetP()->glFocus(*argV->pVec);
	}

	bool fk_Model::glFocus(double argX, double argY, double argZ)
	{
		return GetP()->glFocus(argX, argY, argZ);
	}

	bool fk_Model::loFocus(fk_Vector^ argV)
	{
		if(!argV) return false;
		return GetP()->loFocus(*argV->pVec);
	}

	bool fk_Model::loFocus(double argX, double argY, double argZ)
	{
		return GetP()->loFocus(argX, argY, argZ);
	}

	bool fk_Model::glVec(fk_Vector^ argV)
	{
		if(!argV) return false;
		return GetP()->glVec(*argV->pVec);
	}

	bool fk_Model::glVec(double argX, double argY, double argZ)
	{
		return GetP()->glVec(argX, argY, argZ);
	}

	bool fk_Model::glUpvec(fk_Vector^ argV)
	{
		if(!argV) return false;
		return GetP()->glUpvec(*argV->pVec);
	}

	bool fk_Model::glUpvec(double argX, double argY, double argZ)
	{
		return GetP()->glUpvec(argX, argY, argZ);
	}

	bool fk_Model::loUpvec(fk_Vector^ argV)
	{
		if(!argV) return false;
		return GetP()->loUpvec(*argV->pVec);
	}

	bool fk_Model::loUpvec(double argX, double argY, double argZ)
	{
		return GetP()->loUpvec(argX, argY, argZ);
	}

	bool fk_Model::glAngle(fk_Angle^ argAngle)
	{
		if(!argAngle) return false;
		return GetP()->glAngle(*argAngle->pAngle);
	}

	bool fk_Model::glAngle(double argH, double argP, double argB)
	{
		return GetP()->glAngle(argH, argP, argB);
	}

	bool fk_Model::loAngle(fk_Angle^ argAngle)
	{
		if(!argAngle) return false;
		return GetP()->loAngle(*argAngle->pAngle);
	}

	bool fk_Model::loAngle(double argH, double argP, double argB)
	{
	...
	void fk_Model::setBMode(fk_BoundaryMode argMode)
	{
		switch(argMode) {
	...
	fk_BoundaryMode fk_Model::getBMode(void)
	{
	...
	void fk_Model::setSphere(double argR)
	{
		GetP()->setSphere(argR);
	}

	double fk_Model::getSphere(void)
	{
		return GetP()->getSphere();
	}

	void fk_Model::setAABBSize(double argX, double argY, double argZ)
	{
		GetP()->setAABBSize(argX, argY, argZ);
	}

	void fk_Model::setAABBSize(fk_Vector^ argSize)
	{
		GetP()->setAABBSize(*argSize->pVec);
	}

	fk_Vector^ fk_Model::getAABBSize(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
	...
	void fk_Model::setOBBSize(double argX, double argY, double argZ)
	{
		GetP()->setOBBSize(argX, argY, argZ);
	}

	void fk_Model::setOBBSize(fk_Vector^ argSize)
	{
		GetP()->setOBBSize(*argSize->pVec);
	}

	fk_Vector^ fk_Model::getOBBSize(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
	...
	void fk_Model::setCapsule(fk_Vector^ argS, fk_Vector^ argE, double argR)
	{
		if(!argS || !argE) return;
		GetP()->setCapsule(*argS->pVec, *argE->pVec, argR);
	}

	double fk_Model::getCapsuleRadius(void)
	{
		return GetP()->getCapsuleRadius();
	}

	double fk_Model::getCapsuleLength(void)
	{
		return GetP()->getCapsuleLength();
	}

	fk_Vector^ fk_Model::getCapsuleStartPos(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
	...
	fk_Vector^ fk_Model::getCapsuleEndPos(void)
	{
		fk_Vector^ V = gcnew fk_Vector();
	...
	void fk_Model::setBDrawToggle(bool argMode)
	{
		GetP()->setBDrawToggle(argMode);
	}

	bool fk_Model::getBDrawToggle(void)
	{
		return GetP()->getBDrawToggle();
	}

	void fk_Model::setBLineColor(fk_Color^ argC)
	{
		if(!argC) return;
		GetP()->setBLineColor(*argC->pCol);
	}

	fk_Color^ fk_Model::getBLineColor(void)
	{
	...
	void fk_Model::setBIntLineColor(fk_Color^ argC)
	{
		GetP()->setBIntLineColor(*argC->pCol);
	}

	fk_Color^ fk_Model::getBIntLineColor(void)
	{
		fk_Color^ C = gcnew fk_Color();
	...
	void fk_Model::setBLineWidth(double argWidth)
	{
		GetP()->setBLineWidth(argWidth);
	}

	double fk_Model::getBLineWidth(void)
	{
