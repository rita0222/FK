\chapter{動的な形状生成と形状変形} \label{sec:easygen} ~
...
\section{立体の作成方法 (2)} \label{subsec:solidGen2}
...
上記のプログラム中では、「\verb+vector<***>+」という形式で定義された
変数が3個登場する。
...
\section{面へのマテリアル設定} \label{subsec:ifs_mat}
