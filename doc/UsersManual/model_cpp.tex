...
\myfig{fig:boundary}{./Fig/Boundary_cpp.eps}{width=8truecm}
	{境界ボリューム}{0mm}
...
\myfig{fig:aabb}{./Fig/AABB_cpp.eps}{width=5truecm}
	{回転によるAABBの変化}{0mm}
...
\myfig{fig:obb}{./Fig/OBB_cpp.eps}{width=5truecm}
	{モデル回転に追従するOBB}{0mm}
...
\myfig{fig:capsule}{./Fig/Capsule_cpp.eps}{width=5truecm}
	{カプセル型の境界ボリューム}{0mm}
