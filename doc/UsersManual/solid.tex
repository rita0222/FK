...
\myfig{Fig:Euler01}{./Fig/Euler01.eps}{width=8truecm}
	{makeVertex ・ removeVertex}{0mm}
...
\myfig{Fig:Euler02}{./Fig/Euler02.eps}{width=10truecm}
	{moveVertex}{0mm}
...
\myfig{Fig:Euler03}{./Fig/Euler03.eps}{width=10truecm}
	{makeEdge ・ deleteEdge}{0mm}
...
\myfig{Fig:Euler04}{./Fig/Euler04.eps}{width=8truecm}
	{makeLoop ・ deleteLoop}{0mm}
...
\myfig{Fig:Euler05}{./Fig/Euler05.eps}{width=8truecm}
	{separateLoop ・ uniteLoop}{0mm}
